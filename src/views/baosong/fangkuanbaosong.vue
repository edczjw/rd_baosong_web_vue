...
<div class="box">
        ...
        <div class="searcharea">
            ...
            <el-form-item label="至" prop="endDate">
                <el-date-picker v-model="searchform.endDate" type="date"  style="width: 80%;" value-format="yyyy-MM-dd" clearable
                placeholder="放款结束时间"> </el-date-picker>
            </el-form-item>
            </el-col>
  ...
  data() {
    ...
    getlist() {
      this.listLoading=true;
        this.$http
        .post(
            this.$store.state.domain +"/report/loanInfo/record", this.searchform  
        )
