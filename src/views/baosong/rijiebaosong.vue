...
<div class="box">
        <div class="searcharea">
          <div class="biaoti">监管报送/日结报送</div>
            ...
            <el-form-item label="日结时间"  prop="checkDate">
                <el-date-picker v-model="searchform.checkDate" type="date" value-format="yyyy-MM-dd"
                placeholder="日结日期"> </el-date-picker>
            </el-form-item>
            </el-col>
            ...
            element-loading-spinner="el-icon-loading" border
        ...
        <!-- 分页 -->
          <div class="block ">
            <el-pagination background style="text-align:center" @size-change="handleSizeChange" 
...
export default {
  data() {
    ...
    getlist() {
        ...
        this.$http
        .post(
            this.$store.state.domain +"/report/dayReport/record", this.searchform  
        )
