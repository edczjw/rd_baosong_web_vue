...
<div class="box">
        <div class="searcharea">
            ...
            <el-form :model="searchform" ref="searchform"  size="mini">
            <el-row :gutter="24">
            <el-col :span="6">
            ...
            <el-form-item label="开始时间" prop="startDate">
                <el-date-picker v-model="searchform.startDate" type="date" value-format="yyyy-MM-dd" clearable
                placeholder="签署开始时间" >
                </el-date-picker>
            </el-form-item>
            </el-col>
            ...
            <el-form-item label="至" prop="endDate">
                <el-date-picker v-model="searchform.endDate" type="date" value-format="yyyy-MM-dd" clearable
                placeholder="签署结束时间"> 
                </el-date-picker>
            </el-form-item>
            </el-col>
         ...
         <!-- =============================== 展示表格数据框 =================================== -->
            ...
            size="medium" stripe style="width: 100%; height:100%;">
                ...
                <el-table-column prop="term" label="期限" width="100px" align="center"> </el-table-column>
  ...
  data() {
    ...
    getlist() {
      this.listLoading=true;
        this.$http
        .post(
            this.$store.state.domain +"/report/loanContract/record", this.searchform  
        )
