...
<div class="box">
        <div class="searcharea">
            <div class="biaoti">监管报送/还款报送</div>
            ...
            <el-form-item label="至" prop="endDate">
                ...
                placeholder="还款结束时间" style="width: 80%;"> </el-date-picker>
            </el-form-item>
            </el-col>
...
export default {
  data() {
    ...
    getlist() {
        ...
        this.$http
        .post(
            this.$store.state.domain +"/report/repay/record", this.searchform  
        )
