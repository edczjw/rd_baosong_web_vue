  ...
  <div>
    ...
    >
      ...
      <div class="contt">
        <el-row>
          <el-col :span="8">
            <el-form-item label="渠道代码：" prop="channelCode" :rules="rules">
              <el-select
                v-model.trim="ruleForm.channelCode"
                placeholder="渠道代码"
                size="mini"
                clearable
              >
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="定损日期：" prop="lossDate" :rules="rules">
              <el-date-picker
                v-model.trim="ruleForm.lossDate"
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="查询编号：" prop="reqNo" :rules="rules">
              <el-input v-model.trim="ruleForm.reqNo" placeholder="合同号" clearable size="mini"></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="8">
            <el-form-item label="数据类型：" prop="dataType" :rules="rules">
    ...
    <!-- 合同预览框 -->
    <el-dialog append-to-body title="预览" :visible.sync="dialogVisible" width="86%" top="5vh" center>
      <div class="el-table">
        <table width="100%">
          <tr colspan="6">
            <th colspan="6">坏账信息</th>
          </tr>
          <ul class="miul">
            <li>
              <label>渠道代码：</label>
              <span v-if="this.ruleForm.channelCode == 'M201'">线下小微企业借款</span>
              <span v-if="this.ruleForm.channelCode == 'M202'">线下个人借款</span>
            </li>
            <li>
              <label>合同号：</label>
            ...
            <li>
              <label>坏账金额(元)：</label>
              {{ this.ruleForm.badMoney }}
            </li>
            <li>
              <label>坏账类型：</label>
              <span v-if="this.ruleForm.badType == '1'">普通坏账</span>
              <span v-if="this.ruleForm.badType == '2'">预期转账坏账</span>
            </li>
            <li>
              <label>后续工作：</label>
              {{ this.ruleForm.followUp }}
            </li>
            <li>
              <label>定损日期：</label>
              {{ this.ruleForm.lossDate }}
            </li>
            <li>
              <label>查询编号：</label>
              {{ this.ruleForm.reqNo }}
        ...
        if (valid) {
          this.$confirm("此操作将提交坏账信息, 是否继续?", "提示", {
            ...
            .then(() => {
              this.$http
                .post(
                  this.$store.state.domain + "/under/pushContractLoss",
                  this.ruleForm
                )
